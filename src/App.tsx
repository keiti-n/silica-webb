  ...
  return (
    <div className="page">
      ...
      <main className="grid" style={{
        ...
        <section className="card" onClick={toggleRealtime} style={{height: "150px"}}>
        ...
        <section className="card" style={{height: "150px"}}>
          <div className="card-title">Temperature</div>
          <div className="reading" style={{fontSize: "2em"}}>
            {tempDisplay}
          </div>
          <div className="card-sub">Last checked: {lastTs ? clockTime(lastTs) : "--:--:--"}</div>
        </section>

        <section className="actions card" style={{gridColumn: "1 / -1"}}>
